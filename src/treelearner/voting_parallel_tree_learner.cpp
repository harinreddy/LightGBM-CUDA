...
template <typename TREELEARNER_T>
void VotingParallelTreeLearner<TREELEARNER_T>::Init(const Dataset* train_data, bool is_constant_hessian, bool is_use_subset) {
  TREELEARNER_T::Init(train_data, is_constant_hessian, is_use_subset); // ibmGBT
  rank_ = Network::rank();
...
template class VotingParallelTreeLearner<CUDATreeLearner>; // ibmGBT
