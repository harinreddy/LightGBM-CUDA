...
struct Config {
  ...
  */
  ...
  // ibmGBT
  // desc = log the final OutputMetric (by default we do not log)
  bool log_final_OutputMetric = false;

  // ibmGBT
  // desc = log the time for training (by default we do not log)
  bool log_train_time = false;

  // ibmGBT
  // desc = folder for logging the result (by default './log/')
