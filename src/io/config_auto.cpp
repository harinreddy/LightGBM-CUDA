...
std::unordered_set<std::string> Config::parameter_set({
  ...
  "gpu_device_id",
  "gpu_use_dp",
  "log_final_OutputMetric", // ibmGBT
  "log_train_time", // ibmGBT
  "log_folder", // ibmGBT
  "num_gpu", // ibmGBT
});
...
void Config::GetMembersFromString(const std::unordered_map<std::string, std::string>& params) {
  ...
  // ibmGBT
  GetBool(params, "log_final_OutputMetric", &log_final_OutputMetric);
  GetBool(params, "log_train_time", &log_train_time);
  GetString(params, "log_folder", &log_folder);
...
std::string Config::SaveMembersToString() const {
  ...
  str_buf << "[log_final_OutputMetric: " << log_final_OutputMetric << "]\n"; // ibmGBT
  str_buf << "[log_train_time: " << log_train_time << "]\n"; // ibmGBT
  str_buf << "[log_folder: " << log_folder << "]\n"; // ibmGBT
