...
#include <LightGBM/utils/openmp_wrapper.h> // ibmGBT
...
class Dense4bitsBin : public Bin {
 public:
  ...
  void PinData() override {
     ...
     printf("Pinned data of Dense4bitBin (size: %lu)\n", len_pin_);
  }
  ...
  void CopySubset(const Bin* full_bin, const data_size_t* used_indices, data_size_t num_used_indices) override {
    ...
    #pragma omp parallel for schedule(static) // ibmGBT: No perforamnce gain
 ...
 protected:
  Dense4bitsBin(const Dense4bitsBin& other)
    : num_data_(other.num_data_), data_(other.data_), buf_(other.buf_), len_pin_(other.len_pin_){} // ibmGBT
