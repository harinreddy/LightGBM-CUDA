...
template <typename TREELEARNER_T>
void DataParallelTreeLearner<TREELEARNER_T>::Init(const Dataset* train_data, bool is_constant_hessian, bool is_use_subset) {
...
template class DataParallelTreeLearner<CUDATreeLearner>; //ibmGBT
